...
../run-clang-tidy.py -quiet -header-filter=.*/src/.* -export-fixes=tidy.yaml || { echo "::warning::Unable to run clang-tidy"; }
...
timeout 30 build/tests/tests [graded] -r=github || { echo "::error::Not all graded tests passed!"; exit 1; }
